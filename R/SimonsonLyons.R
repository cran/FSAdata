#' @title Catches in removal events of trout at various locations.
#'
#' @description Catches of various species in consecutive removal events at various locations.
#'
#' @name SimonsonLyons
#' 
#' @docType data
...
#' @concept Removal
#' 
#' @source From Appendix in Simonson, T.D. and J. Lyons.  1995.  Comparison of catch per effort and removal procedures for sampling stream fish assemblages. North American Journal of Fisheries Management, 15:419-427.
#'
#' @keywords datasets
#' 
#' @examples
