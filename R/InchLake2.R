#' @title Lengths and weights of fish captured in Inch Lake
#' 
#' @description Total lengths and weights of a subsample of fish captured in Inch Lake, Bayfield County, WI in May, 2007 and May, 2008.
#' 
#' @name InchLake2
#' 
#' @docType data
