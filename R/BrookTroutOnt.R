...
#' @concept Petersen
#' 
#' @source From Table 1 of Curry, R.A., C. Brady, and G.E. Morgan. 2003. Effects of Recreational Fishing on the Population Dynamics of Lake-Dwelling Brook Trout. North American Journal of Fisheries Management 23:35-47. \href{https://raw.githubusercontent.com/fishR-Core-Team/FSAdata/main/data-raw/BrookTroutOnt.csv}{CSV file}
#' 
#' @keywords datasets
#' 
#' @examples
