...
#' 
#' @source Data from table 1 in Bronte, C.R., J.H. Selgeby, D.V.Swedberg.  1993.  Dynamics of a yellow perch population in Western Lake Superior.  North American Journal of Fisheries Management 13:511-523.
#' 
#' @keywords datasets
#' 
#' @examples
