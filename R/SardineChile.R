#' @title Ages and lengths of two year-classes of Sardine from Chilean waters.
#'
#' @description Ages (in months) and total lengths of two year-classes of Sardine (\emph{Strangomera bentincki}) from central Chilean waters.
#'
#' @name SardineChile
#' 
#' @docType data
