...
#' @concept Catch Curve
#' 
#' @source From (approximately) Figure 2 in Kwak, T.J., W.E. Pine III, and D.S. Waters. 2006. Age, growth, and mortality of introduced flathead catfish in Atlantic rivers and a review of other populations. North American Journal of Fisheries Management 26:73-87. \href{https://raw.githubusercontent.com/fishR-Core-Team/FSAdata/main/data-raw/FHCatfishATL.csv}{CSV file}
#' 
#' @keywords datasets
#' 
#' @examples
