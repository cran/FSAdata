#' @title Biological characteristics of Ruffe captured in the St. Louis River, Lake Superior in 1992.
#' 
#' @description Biological characteristics of Ruffe (\emph{Gymnocephalus cernuus}) captured in the St. Louis River, Lake Superior in 1992.
#' 
#' @name RuffeSLRH92
#' 
#' @docType data
