...
#' @concept Somers
#' 
#' @source From figure 9 of Cubillos, L.A., D.F. Arcosa, D.A. Bucareya, M.T. Canalesa. 2001. Seasonal growth of small pelagic fish off Talcahuano, Chile (37S, 73W): A consequence of their reproductive strategy to seasonal upwelling? Aquatic Living Resources, 14:115-124. \href{https://raw.githubusercontent.com/fishR-Core-Team/FSAdata/main/data-raw/AHerringChile.csv}{CSV file}
#' 
#' @keywords datasets
#' 
#' @examples
