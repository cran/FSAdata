...
#' @concept Recruitment
#' 
#' @source From Jacobson, L.D. and A.D. MacCall. 1995. Stock-recruitment models for Pacific Sardine (\emph{Sardinops sagax}). Canadian Journal of Fisheries and Aquatic Sciences 52:566-577. \href{https://raw.githubusercontent.com/fishR-Core-Team/FSAdata/main/data-raw/SardinesPacific.csv}{CSV file}
#' 
#' @keywords datasets
#' 
#' @examples
