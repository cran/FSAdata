#' @title Biological characteristics of Lake Trout from Arctic LTER.
#' 
#' @description Biological characteristics -- lengths, weight, age, and sex -- of Lake Trout (\emph{Salvelinus namaycush}) from sampled from Lake NE12 of the Arctic Long Term Ecological Research location.
#' 
...
#' 
#' @source Data was originally available at \url{ecosystems.mbl.edu/ARC/lakes/fish/89mcne12.html}.  However, it does not appear to be available there now.  It seems like it should still be available at the \href{http://ecosystems.mbl.edu/ARC/lakes/fish/index.shtml}{Arctic LTER site}.
#' 
#' @keywords datasets
#' 
#' @examples
