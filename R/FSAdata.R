...
#' 
#' \tabular{ll}{
#'  \code{help.search("Length-Weight",package=c("FSAdata","FSA"))} \tab Length-weight model data.\cr
#'  \code{help.search("Growth",package=c("FSAdata","FSA"))} \tab Growth model data.\cr
#'  \code{help.search("Bertalanffy",package=c("FSAdata","FSA"))} \tab von Bertalanffy growth model data.\cr
#'  \code{help.search("Stock-Recruit",package=c("FSAdata","FSA"))} \tab Stock-recruitment data.\cr 
#'  \code{help.search("Recruitment",package=c("FSAdata","FSA"))} \tab Recruitment time-series data.\cr
