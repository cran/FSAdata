...
#' 
#' @source From Table 1 of Clarke, R.P., and S.S. Yoshimoto. 1990. Application of the Leslie model to commercial catch and effort of the slipper lobster, \emph{Scyllarides squammosus}, fishery in the northwestern hawaiian islands. Marine Fisheries Review 52(2):1-7. \href{https://raw.githubusercontent.com/fishR-Core-Team/FSAdata/main/data-raw/LobsterHI.csv}{CSV file}
#' 
#' @keywords datasets
#' 
#' @examples
