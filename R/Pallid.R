...
#' 
#' @source From Table 1 in Keenlyne, K.D. and S.J. Maxwell. 1993. Length conversions and length-weight relations for pallid sturgeon. North American Journal of Fisheries Management 13:395-397. \href{https://raw.githubusercontent.com/fishR-Core-Team/FSAdata/main/data-raw/Pallid.csv}{CSV file}
#' 
#' @keywords datasets
#' 
#' @examples
