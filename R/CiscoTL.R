#' @title Lengths and weights of Cisco from Trout Lake.
#'
#' @description Lengths and weights of Cisco (\emph{Coregonus artedii}) from Trout Lake, 1981-2006.  Fish were collected with a variety of gears.
#'
#' @name CiscoTL
#'
#' @docType data
