...
#' 
#' @source Simulated from the age-length data provided in Table 1 of House, R., and L. Wells. 1973. Age, growth, spawning season, and fecundity of the trout-perch (\emph{Percopsis omsicomaycus}) in southeastern Lake Michigan. Journal of the Fisheries Research Board of Canada 30:1221-1225. \href{https://raw.githubusercontent.com/fishR-Core-Team/FSAdata/main/data-raw/TroutperchLM1.csv}{CSV file}
#' 
#' @keywords datasets
#' 
#' @examples
