...
#' 
#' @description Single census mark-recapture data for Brown Trout (\emph{Salmo trutta}) from Valley Creek, MN captured in April, 1988. Length of trout was recorded so that abundance estimated can be made by length categories.
#' 
#' @name BrownTroutVC1
#' 
#' @docType data
...
#' @concept Petersen
#' 
#' @source Obtained directly from Tom Kwak, North Carolina Cooperate Unit at North Carolina State University and part of the data published in Kwak, T.J. and T.F. Waters. 1997. Trout production dynamics and water quality in Minnesota streams. Transactions of the American Fisheries Society, 126:35-48. \href{https://raw.githubusercontent.com/fishR-Core-Team/FSAdata/main/data-raw/BrownTroutVC1.csv}{CSV file}
#' 
#' @keywords datasets
#' 
#' @examples
