...
#'
#' @source From Table 4 (a random tenths digit was added to the TL) in Bailey, M.M.  1963.  \href{http://fishbull.noaa.gov/63-1/bailey.pdf}{Age, growth, and maturity of round whitefish of the Apostle Islands and Isle Royale Regions, Lake Superior.}  Fishery Bulletin, 63:63-75. 
#'
#' @keywords datasets
#'
#' @examples
