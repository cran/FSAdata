#' @title Age (subsample) and length (all fish) of Morwong from Morwong4.
#' 
#' @description A total of 104 fish dispersed proportionately over 1-cm fork length intervals from the \code{Morwong4} data frame was obtained for age assignment.  The remaining fish in the file were only measured for length (i.e., the ages were deleted).  This data file can be used to demonstrate the use of age-length keys.
#' 
#' @name Morwong4a
#' 
#' @docType data
